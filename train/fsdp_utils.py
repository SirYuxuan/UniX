...
from modeling.unix.modeling_utils import MLPconnector, TimestepEmbedder, PositionEmbedding
from modeling.unix.qwen2_navit import (
    Qwen2DecoderLayer,
    Qwen2MoEDecoderLayer,
    Qwen2MoTDecoderLayer,
)
from modeling.unix.siglip_navit import SiglipEncoderLayer, SiglipVisionTransformer
...
def fsdp_wrapper(original_model, fsdp_config, ignored_modules=[]):
    ...
    # Get use_orig_params from fsdp_config if it exists, otherwise default to False
    use_orig_params = getattr(fsdp_config, 'use_orig_params', False)
    ...
    return FSDP(
        ...
        use_orig_params=use_orig_params,  # Add this parameter
    )
